...
pathology = pd.read_csv('/all_mass_pathology.csv')
...
sorted_merged_df.to_csv('/598_percentage_all.csv')
...
#save the output
df_sort.to_csv('/heaght_width_FULL.csv')
